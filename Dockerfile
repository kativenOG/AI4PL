...
RUN apt-get install --no-install-recommends software-properties-common &&  apt-add-repository "deb https://dl.winehq.org/wine-builds/debian/ $(lsb_release -cs) main"
RUN apt update && apt-get install -y winehq-stable
RUN wine --version
